...
public static class MovieFactory
{
    public static void Execute(ModelBuilder modelBuilder)
    {
        var movies = new[]
        {
            new MovieEntity
            {
                Id = 1, Title = "A New Hope", Episode = 4,
                OpeningCrawl =
            ...
            new MovieEntity
            {
                Id = 2, Title = "The Empire Strikes Back", Episode = 5,
                OpeningCrawl =
            ...
            new MovieEntity
            {
                Id = 3, Title = "Return of the Jedi", Episode = 6,
                OpeningCrawl =
            ...
            new MovieEntity
            {
                Id = 4, Title = "The Phantom Menace", Episode = 1,
                OpeningCrawl =
            ...
            new MovieEntity
            {
                Id = 5, Title = "Attack of the Clones", Episode = 2,
                OpeningCrawl =
            ...
            new MovieEntity
            {
                Id = 6, Title = "Revenge of the Sith", Episode = 3,
                OpeningCrawl =
